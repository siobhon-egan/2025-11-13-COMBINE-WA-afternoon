...
The *[GenomicRanges](https://bioconductor.org/packages/3.22/GenomicRanges)* package implements
...
*[GenomicRanges](https://bioconductor.org/packages/3.22/GenomicRanges)* package is available in one of the
...
defined in the *[BiocIO](https://bioconductor.org/packages/3.22/BiocIO)* package - with methods
implemented in the *[rtracklayer](https://bioconductor.org/packages/3.22/rtracklayer)* package - as a
...
Refer to the documentation of the *[rtracklayer](https://bioconductor.org/packages/3.22/rtracklayer)*
